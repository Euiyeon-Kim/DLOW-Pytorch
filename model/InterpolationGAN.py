...
class InterpolationGAN(nn.Module):
    ...
    def set_input(self, input):
        ...
        self.ans_real = Variable(torch.ones([self.params.batch_size, 1, 16, 23]), requires_grad=False)
        self.ans_fake = Variable(torch.zeros([self.params.batch_size, 1, 16, 23]), requires_grad=False)

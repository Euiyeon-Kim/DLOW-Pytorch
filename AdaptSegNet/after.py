...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = './datasets/DLOW'
DATA_LIST_PATH = './datasets/Source_list/Atrain.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '1280,720'
DATA_DIRECTORY_TARGET = './datasets/Cityscapes'
DATA_LIST_PATH_TARGET = './datasets/Target_list/train.txt'
...
SNAPSHOT_DIR = './AdaptSegNet/checkpoint/'
WEIGHT_DECAY = 0.0005
LOG_DIR = './log'
